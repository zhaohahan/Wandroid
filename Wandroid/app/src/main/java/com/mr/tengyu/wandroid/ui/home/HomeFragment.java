...
import com.mr.tengyu.wandroid.ui.search.SearchActivity;
...
public class HomeFragment extends Fragment implements Homeconstant.HomeView, Homeconstant2.HomeView {
    ...
    private void initView(final View inflate) {
        ...
        myRV_adapter.setOnBannerClicklisenter ( new MyRV_adapter.OnBannerClicklisenter ( ) {
            @Override
            public void sendURL(int position) {
                HomeBannerBean.DataBean dataBean = bannerList.get ( position );
                Intent intent = new Intent ( getActivity ( ), WebActivity.class );
