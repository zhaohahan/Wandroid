...
public class FlowLayout_zhao extends RelativeLayout {
    ...
    public FlowLayout_zhao(Context context) {
        super ( context );
    }

    public FlowLayout_zhao(Context context, AttributeSet attrs) {
        super ( context, attrs );
    }

    public FlowLayout_zhao(Context context, AttributeSet attrs, int defStyleAttr) {
        super ( context, attrs, defStyleAttr );
    }

    public FlowLayout_zhao(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
